...
export const BroomIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M14.44 2.245a.75.75 0 01.311 1.035l-1.88 3.29a.75.75 0 01-1.342-.768l1.88-3.29a.75.75 0 011.03-.311zM17.75 4.5a.75.75 0 01.75.75v.096c0 .356-.168.687-.452.888l-5.626 3.125a.75.75 0 01-.896 0L6.452 6.234A1.001 1.001 0 006 5.346V4.5a.75.75 0 01.75-.75h10.25a.75.75 0 01.75.75zM3.843 8.355a.75.75 0 011.03-.311l1.88 3.29a.75.75 0 01-.768 1.342l-1.88-3.29a.75.75 0 01-.312-1.031zM9.075 14.25a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
    </svg>
);

export const SortAscendingIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path d="M3 3a1 1 0 000 2h14a1 1 0 100-2H3zm0 4a1 1 0 000 2h14a1 1 0 100-2H3zm0 4a1 1 0 100 2h14a1 1 0 100-2H3zm0 4a1 1 0 100 2h14a1 1 0 100-2H3z" />
    </svg>
);

export const SortDescendingIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h2a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
    </svg>
);
